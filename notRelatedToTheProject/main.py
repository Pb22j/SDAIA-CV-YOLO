...
def main():
    ...
    video_output_path = 'output_tracking1.mp4'
    ...
    for idx, frame_path in enumerate(frame_paths):
        ...
        for res in results:
            ...
            # (Optional) We can track trajectory history, but drawing it in 360-panning videos creates messy zig-zag lines.
            ...
            # # Draw trajectory trail (Disabled by user request)
